    ...
    <nav class="navbar navbar-expand-lg mcf-navbar-light" aria-label="main menu">
        <div class="container-xxl">
            <a class="navbar-brand" href="/">
                <p class="mcf-logo-title h4"><img src="../images/heart-infinity.png" alt="Heart wreath with infinity through the middle." width="60" height="40" class="pe-2">Millie's Crazy Flowers</p>
            </a>
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                        <div class="p-3 text-bg-light hero-text-border" title="">
                            <section aria-label="Terms of Service">
                                ...
                                <div id="os"><strong>1. OUR SERVICES</strong></div>
                                ...
                                <div id="ipr"><strong>2. INTELLECTUAL PROPERTY RIGHTS</strong></div>
                                ...
                                <div id="ureg"><strong>4. USER REGISTRATION</strong></div>
                                ...
                                <div id="pro"><strong>5. PRODUCTS</strong></div>
                                ...
                                <div id="pap"><strong>6. PURCHASES AND PAYMENT</strong></div>
                                ...
                                <div id="cl"><strong>10. CONTRIBUTION LICENSE</strong></div>
                                ...
                                <div id="gfr"><strong>11. GUIDELINES FOR REVIEWS</strong></div>
                                ...
                                <ul>
                                    ...
                                    <li>(2) your reviews should not contain offensive profanity, or abusive, racist, offensive, or hateful language;</li>
                                ...
                                <div id="tpwac"><strong>12. THIRD-PARTY WEBSITES AND CONTENT</strong></div>
                                ...
                                <div id="smang"><strong>13. SERVICES MANAGEMENT</strong></div>
                                ...
                                <div id="ppolicy"><strong>14. PRIVACY POLICY</strong></div>
                                ...
                                <div id="tat"><strong>16. TERM AND TERMINATION</strong></div>
                                ...
                                <div id="mai"><strong>17. MODIFICATIONS AND INTERRUPTIONS</strong></div>
                                ...
                                <div id="gl"><strong>18. GOVERNING LAW</strong></div>
                                ...
                                <div id="dr"><strong>19. DISPUTE RESOLUTION</strong></div>
                                ...
                                <div id="corr"><strong>20. CORRECTIONS</strong></div>
                                There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
                                <br><br>

                                <div id="disc"><strong>21. DISCLAIMER</strong></div>
                                ...
                                <ul>
                                    <li>(a) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS,</li>
                                    <li>(b) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES,</li>
                                    <li>(c) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN,</li>
                                    <li>(d) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES,</li>
                                    <li>(e) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR</li>
                                    <li>(f) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES.</li>
                                </ul>
                                WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.
                                <br><br>

                                <div id="lol"><strong>22. LIMITATIONS OF LIABILITY</strong></div>
                                ...
                                <div id="indemn"><strong>23. INDEMNIFICATION</strong></div>
                                ...
                                <div id="udata"><strong>24. USER DATA</strong></div>
                                ...
                                <div id="ectas"><strong>25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong></div>
                                ...
                                <div id="cuar"><strong>26. CALIFORNIA USERS AND RESIDENTS</strong></div>
                                ...
                                <br><br>
                                <a href="https://millies.crazyflowers.art" class="mcf-link  fw-bold" target="_blank" rel="noopener noreferrer">millies.crazyflowers.art<span class="sr-only">(Opens a new window)</span></a>
                                <br>
