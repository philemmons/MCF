                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 my-2 my-lg-5">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Under Millie's Legacy, 50% of all proceeds will be donated to charity, <a href="https://www.crossingbridgestrc.org/" class="mcf-link  fw-bold" target="_blank">Crossing Bridges Therapeutic Riding Center</a> that will provide sponsorship for the special needs and <a href="https://soor.org/give/" class="mcf-link  fw-bold" target="_blank">Special Olympics Oregon that "empowers athletes to exceed their personal bests on and off the playing field."</a>
                            </p>
                            <p class="card-text">
