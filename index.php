...
<nav class="navbar navbar-expand-lg obframe mb-5 mx-2 mx-lg-5">
  <div class="container">
    ...
    <button class="navbar-toggler d-lg-none ms-6 ms-xs-0" type="button" data-bs-toggle="collapse" data-bs-target="#topNavbar" aria-controls="topNavbar" aria-expanded="false" aria-label="Toggle navigation">
