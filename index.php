      ...
      <div class="row text-center">
        <div class="col-lg-4 p-3 p-lg-5">
          <div class="hiw-icon info-4">
            ...
            <img src= "../images/quote.png" class= "img-fluid" alt= "Delivery truck icon" >
          </div>
          <div class="card-body">
        ...
        <div class="col-lg-4 p-3 p-lg-5">
          <div class="hiw-icon info-1">
            ...
            <img src= "../images/production.png" class= "img-fluid" alt= "Delivery truck icon" >
          </div>
          <div class="card-body">
        ...
        <div class="col-lg-4 p-3 p-lg-5">
          <div class="hiw-icon info-4">
            ...
            <img src= "../images/delivery.png" class= "img-fluid" alt= "Delivery truck icon" >
          </div>
          <div class="card-body">
