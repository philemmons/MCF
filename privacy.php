...
<body id="toTop">
    ...
    <header id="main-content">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center align-items-end mb-5 bg-frame bg-img-privacy">
                <div class="col-xl-6 col-lg-7 col-md-9">
                    ...
                    <div class="text-center h1-ls" title="Privacy Policy">
                        <section aria-label="Page Intro">
                            <h1 class="bswash-font pb-4 px-3 px-md-0">Privacy Policy
                            </h1>
                        </section>
                    </div>
                </div>
                        ...
                        <div class="p-3 text-bg-light hero-text-border">
                            <section aria-label="Privacy Policy">
                                ...
                                <ol>
                                    ...
                                    <li>Or any website of ours that links to this privacy notice</li>
                                </ol>
                                ...
                                <div id="sensitiveinfo"><strong>Sensitive Information.</strong>
                                    <br>
                                    ...
                                    <ol>
                                        ...
                                        <li><strong>To post testimonials.</strong> We post testimonials on our Services that may contain personal information.</span></li>
                                    ...
                                    <div id="whoshare"><strong>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</strong></div>

                                    <br>
                                    <strong>In Short:</strong>
                                    <br>We may share information in specific situations described in this section and/or with the following third parties.
                                    ...
                                    <div id="infosafe"><strong>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong></div>
                                    ...
                                    <div id="infominors"><strong>7. DO WE COLLECT INFORMATION FROM MINORS?</strong></div>
                                    <br>
                                    <strong>In Short:</strong>
                                    <br>
                                    ...
                                    <div id="uslaws"><strong>10. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></div>
                                    <br>
                                    <strong>In Short:</strong>
                                    <br>
                                    If you are a resident of <strong>California</strong>, you are granted specific rights regarding access to your personal information.
                                    <br><br>
                                    ...
                                    <br>
                                    <ul>
                                        <li>(a) every individual who is in the State of California for other than a temporary or transitory purpose and</li>
                                        <li>(b) every individual who is domiciled in the State of California who is outside the State of California for a temporary or transitory purpose</li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>(b) the categories of personal information that we collect;</li>
                                        <li>(c) the purposes for which the collected personal information is used;</li>
                                        <li>(d) whether we sell or share personal information to third parties;
                                        <li>(e) the categories of personal information that we sold, shared, or disclosed for a business purpose;</li>
                                        <li>(f) the categories of third parties to whom the personal information was sold, shared, or disclosed for a business purpose;</li>
                                        <li>(g) the business or commercial purpose for collecting, selling, or sharing personal information; and</li>
                                        <li>(h) the specific pieces of personal information we collected about you.</li>
                                    </ul>
                                    ...
                                    <div id="policyupdates"><strong>11. DO WE MAKE UPDATES TO THIS NOTICE?</strong></div>
